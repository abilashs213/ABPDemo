...
using ABP.Demo.Shared.Hosting.Microservices.DbMigrations;
using Volo.Abp.Data;
...
namespace ABP.Demo.AppointmentService.DbMigrations;

public class AppointmentServiceDatabaseMigrationEventHandler
    : DatabaseMigrationEventHandlerBase<AppointmentServiceDbContext>,
        IDistributedEventHandler<TenantCreatedEto>,
        IDistributedEventHandler<TenantConnectionStringUpdatedEto>,
        IDistributedEventHandler<ApplyDatabaseMigrationsEto>
{
    public AppointmentServiceDatabaseMigrationEventHandler(
        ...
        tenantRepository,
        distributedEventBus,
        AppointmentServiceDbProperties.ConnectionStringName)
    {
