...
using ABP.Demo.Shared.Hosting.Gateways;
using Ocelot.Middleware;
using Volo.Abp;
using Volo.Abp.Modularity;

namespace ABP.Demo.PublicWebGateway;

[DependsOn(
    typeof(DemoSharedHostingGatewaysModule)
)]
public class DemoPublicWebGatewayModule : AbpModule
{
